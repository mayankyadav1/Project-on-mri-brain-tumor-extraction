function kmeans_tumor_extracted(hobject , event,axisg5H)%With erosion and Dilation
%clear;
%clc;
global image_no;
global image_data;
...
for itr = 1:k
 ...
 imshow(extracted_tumor,'parent',axisg5H);
 title(axisg5H,'TUMOR AFTER MORPHOLOGICAL ANALYSIS','color','r');
end
